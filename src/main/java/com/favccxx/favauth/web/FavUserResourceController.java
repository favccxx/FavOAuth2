...
@Controller
public class FavUserResourceController {
	...
	public HttpEntity accessUserResource(HttpServletRequest request) throws OAuthSystemException{
		try {
            ...
            //验证Access Token
            if (!favAuthService.checkAccessToken(accessToken)) {
            ...
            //返回用户名
            String username = favAuthService.getUsernameByAccessToken(accessToken);
