...
<head>
  ...
  <script type="text/javascript">
  	function oauth2Login(){
  		...
  		var webId = $('input[name="favAppSiteRadio"]:checked').val();
  		...
  		window.parent.changeIframe("oauth2/oauth2login?webId=" + webId);
        ...
        <form class="am-form">
          ...
          <tbody>
          	<c:forEach items="${websiteList }" var="webSiteItem">
          		<tr>
          			<td><input type="radio" name="favAppSiteRadio" value="${webSiteItem.webId }"/></td>
