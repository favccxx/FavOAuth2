	...
	<div class="WB_xline1 oauth_xline" id="outer">
		<div class="oauth_wrap">
	    	...
	    	<div class="WB_panel oauth_main">
	    		<form name="authZForm" action="<%=basePath %>server/applyAuthorize" method="post" node-type="form">
	      			<div class="oauth_content">
	        				...
	        				<div class="app_info clearfix">
	        					...
	        					<div class="app_info_plus">
	        						...
	        						<div class="app_user_list">
			        					<ul class="clearfix">
						              		<li><a href="#"><img src="https://upload.api.weibo.com/tp/1666068804/50/5711442138/1" title="小西"></a></li>						               		
						               		<li><a href="#"><img src="https://upload.api.weibo.com/tp/1642471052/50/40021495778/1" title="TechWeb"></a></li>						               		
						               		<li><a href="#"><img src="https://upload.api.weibo.com/tp/1753061523/50/5647677368/0" title="Sally"></a></li>
						               	</ul>
			        				</div>
								</div>
	        				</div>
	        			...
	        			<div class="oauth_login_box01 clearfix">    	
	        				...
	        				<input type="hidden" id="client_id" name="client_id" value="${authApp.appKey }">
	        				...
	        				<input type="hidden" id="state" name="state" value="20b9ecfda10f843b0f3eb7632ecd3561"/>		          
					  		...
					  		<input type="hidden" name="redirect_uri" value="http://localhost:8080/FavOAuth2/client/authCodeRequest"/>
